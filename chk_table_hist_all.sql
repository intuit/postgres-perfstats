...
-- 1) Set begin snap id (bsnap) and end snap id (esnap)
...
-- 2) Run this script
-- pqbopc04p=> \i chk_table_hist_all.sql
...
select a.snap_id snap_id_begin,
  ...
  from perfstat.pg_stat_all_tables_hist a right join perfstat.pg_stat_all_tables_hist b
    on (a.schemaname = b.schemaname and a.relname = b.relname and b.snap_id = a.snap_id + 1)
